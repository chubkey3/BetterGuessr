...
if (process.env.PROD !== 'production'){
    ...
    updateRoom('abc', {team1_guesses: [], team2_guesses: [], team1_users: [], team2_users: [], started: false, guessed: 0, team1_health: 5000, team2_health: 5000, countdown_time: 15, round: 1})
    .then(() => {
